...
void setupOverworldGenerator(LayerStack *g, int mc) {
    ...
    //             G, L,                    M               V   Z  E  S     P1 P2
    p = setupLayer(g, L_CONTINENT_4096, mapContinent, mc, 1, 0, 1, 0, 0); //1
    p = setupLayer(g, L_ZOOM_2048, mapZoomFuzzy, mc, 2, 3, 2000, p, 0); //2
    p = setupLayer(g, L_LAND_2048, mapLand, mc, 1, 2, 1, p, 0); //3
    p = setupLayer(g, L_ZOOM_1024, mapZoom, mc, 2, 3, 2001, p, 0);//4
    p = setupLayer(g, L_LAND_1024_A, mapLand, mc, 1, 2, 2, p, 0);//5

    //             G  L                 M               V   Z  E  S     P1 P2
    p = setupLayer(g, L_LAND_1024_B, mapLand, mc, 1, 2, 50, p, 0); //6
    p = setupLayer(g, L_LAND_1024_C, mapLand, mc, 1, 2, 70, p, 0);//7
    p = setupLayer(g, L_ISLAND_1024, mapIsland, mc, 1, 2, 2, p, 0);//8
